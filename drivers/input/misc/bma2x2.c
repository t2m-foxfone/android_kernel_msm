...
#define SENSOR_IDENTIFICATION_ENABLE 	0
...
#if SENSOR_IDENTIFICATION_ENABLE
		...
		const struct i2c_device_id *id)
{
	...
	printk("Jerry: bma2x2_probe() tmp_chip_id = %d \n", tmp_chip_id);
	switch (tmp_chip_id) {
	case BMA255_CHIP_ID:
